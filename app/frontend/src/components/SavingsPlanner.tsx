...
const SavingsPlanner: React.FC = () => {
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div>
                <h2 className="text-3xl font-bold tracking-tight text-foreground mb-2">Savings Goal Planner</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-1 space-y-6">
                    <div className="glass-card p-6 space-y-6">
                        <div className="space-y-4">
                            <label className="block text-sm font-bold text-foreground/70 uppercase tracking-widest flex items-center gap-2">
                            ...
                            <input
                                ...
                                className="w-full bg-secondary border border-border rounded-xl px-4 py-3 text-foreground focus:outline-none focus:ring-2 focus:ring-primary-500/50 transition-all font-mono text-lg placeholder:text-foreground/30"
                            />
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <select
                                ...
                                className="w-full bg-secondary border border-border rounded-xl px-4 py-3 text-foreground focus:outline-none focus:ring-2 focus:ring-primary-500/50 transition-all appearance-none cursor-pointer"
                            >
                                <option className="bg-background" value="Safety">Safety (2%)</option>
                                <option className="bg-background" value="Very Conservative">Very Conservative (3%)</option>
                                <option className="bg-background" value="Conservative">Conservative (4%)</option>
                                <option className="bg-background" value="Moderate">Moderate (5%)</option>
                                <option className="bg-background" value="Aggressive">Aggressive (7%)</option>
                                <option className="bg-background" value="Very Aggressive">Very Aggressive (9%)</option>
                            </select>
                        </div>
                ...
                <div className="lg:col-span-2 space-y-6">
                    {result ? (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 h-full">
                            <div className="flex flex-col gap-6">
                                <div className="glass-card p-8 border-primary-500/30 bg-primary-500/5 flex-1">
                                    <div className="text-foreground/50 text-xs font-bold uppercase tracking-widest mb-2">Required Monthly Savings</div>
                                ...
                                <div className="glass-card p-8 border-border bg-secondary/50">
                                    <div className="text-foreground/30 text-xs font-bold uppercase tracking-widest mb-2">Without Investing</div>
                                    <div className="text-3xl font-bold text-foreground/60 mb-1">
                            ...
                            <div className="glass-card p-6 border-border flex flex-col h-full">
                                <h3 className="text-sm font-bold text-foreground/80 mb-6 flex items-center gap-2 uppercase tracking-wide">
                        ...
                        <div className="glass-card h-full flex flex-col items-center justify-center text-center p-12 border-border/40">
                            <div className="w-20 h-20 rounded-full bg-secondary flex items-center justify-center mb-6">
                                <Target className="w-10 h-10 text-foreground/10" />
                            </div>
                            <h3 className="text-xl font-bold text-foreground/40 mb-2">Awaiting Calculation</h3>
                            <p className="text-foreground/20 max-w-sm italic">
